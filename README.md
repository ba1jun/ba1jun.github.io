<p>
  ...
  <img alt="Astro" src="https://img.shields.io/badge/Astro-7.2.0-FF5D01.svg?logo=astro&logoColor=white" />
...
Revista is a photography portfolio and blog built on Astro v7.2.0. I created it to showcase various photography collections and writing organized into different categories like long-form, short-form, muses, zeitweilig, and my CV. The project prioritizes speed and visual design while using Astro's content collection API to manage everything efficiently.
...
4. **Efficient Bundling**: Astro v7.2.0 includes improved bundling and tree-shaking to minimize client-side code, with enhanced hydration strategies and faster component rendering.
